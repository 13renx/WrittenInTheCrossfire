...
<table>
  ...
  <tbody>
    <tr>
      <td align="center">
        <img src="https://github.com/NatsokoMiruku.png" width="50" height="50" style="border-radius: 50%;" />
      </td>
      <td>
        <strong>Angela Dominique Miguel</strong>  
        <br />
        <a href="https://github.com/NatsokoMiruku">@NatsokoMiruku</a>
      </td>
      <td>
        <ul>
          <li>Artist</li>
    ...
    <tr>
      <td align="center">
        <img src="https://github.com/j-pango.png" width="50" height="50" style="border-radius: 50%;" />
      </td>
      <td>
        <strong>Joaquin Miguel Panganiban</strong>  
        <br />
        <a href="https://github.com/j-pango">@j-pango</a>
      </td>
      <td>
        <ul>
    ...
    <tr>
      <td align="center">
        <img src="https://github.com/anamurielveron.png" width="50" height="50" style="border-radius: 50%;" />
      </td>
      <td>
        <strong>Ana Muriel Veron</strong>  
        <br />
        <a href="https://github.com/anamurielveron">@anamurielveron</a>
      </td>
      <td>
        <ul>
          <li>Writer</li>
